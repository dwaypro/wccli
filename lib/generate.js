var fs = require('fs'),
    ...
    const newComponentSchematicCSS = fs.readFileSync('../bin/assets/schematics/newcomponentschematic/newcomponent/newschematic.css', 'utf8');
    ...
    const newVueComponentSchematicHTML = fs.readFileSync('../bin/assets/schematics/vuecomponentschematic/newschematic.html', 'utf8');
    const newVueComponentSchematicCSS = fs.readFileSync('../bin/assets/schematics/vuecomponentschematic/newschematic.css', 'utf8');
    /**
    ...
    const newVueWebComponentSchematicHTML = fs.readFileSync('../bin/assets/schematics/vuewebcomponentschematic/newschematic.html', 'utf8');
    const newVueWebComponentSchematicCSS = fs.readFileSync('../bin/assets/schematics/vuewebcomponentschematic/newschematic.css', 'utf8');
